...
class EmploymentCheckService
{
    ...
    public function createEmploymentCheck($request)
    {
        // Get user
    ...
    public function updateEmploymentCheck($request)
    {
        // Allowed fields
        $allowedFields = [
            'passport_number',
        ...
        return $employmentCheck->latest('updated_at')->first();
    }

    // Delete employment check
    public function deleteEmploymentCheck($request)
    {
        // Get user
        $user = User::findOrFail($request->user);
    ...
    // Fetch user employment check
    public function fetchSingleEmploymentCheck($request)
    {
        // Get user
        $user = User::findOrFail($request->user);
