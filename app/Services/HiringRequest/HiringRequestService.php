...
class HiringRequestService
{
    ...
    public function createHiringRequest($request)
    {
        ...
        return $hiringRequest->with('applicationManager.profile', 'practice', 'workPatterns.workTimings', 'jobSpecification.responsibilities', 'personSpecification.personSpecificationAttributes', 'profiles', 'department', 'applicants.profile')
    ...
    public function fetchSingleHiringRequest($request)
    {
        ...
        return HiringRequest::where('id', $request->hiring_request)
            ->with('applicationManager.profile', 'practice', 'workPatterns.workTimings', 'jobSpecification.responsibilities', 'personSpecification.personSpecificationAttributes', 'profiles', 'department', 'applicants.profile.user')
            ->get();
    }
    ...
    public function updateHiringRequest($request)
    {
        ...
        if ($request->has('rota_information')) {
            ...
            return $hiringRequest->where('id', $request->rota_information)
                ->with('applicationManager.profile', 'practice', 'workPatterns.workTimings', 'jobSpecification.responsibilities', 'personSpecification.personSpecificationAttributes', 'profiles', 'department', 'applicants.profile')
                ->get();
